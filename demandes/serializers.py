...
class DemandeSerializer(serializers.ModelSerializer):
    ...
    # Read-only flattened client fields (mirror DemandeListSerializer)
    client_name_display = serializers.CharField(source='client.display_name', read_only=True)
    client_phone_display = serializers.CharField(source='client.phone', read_only=True)
    client_whatsapp_display = serializers.CharField(source='client.whatsapp', read_only=True)
